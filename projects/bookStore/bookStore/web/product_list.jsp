			...
			<tr>
				...
				<td>
					<div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp${category}&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;图书列表
					</div>
					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录 </h1>
								<hr />
								<h1>${category}</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${pageResult.totalcnt}种商品
								<hr />
								...
								<div class="pagination">
									 第${pageResult.currenpage}页/共 第${pageResult.totalpage}页
									<ul>

										<c:if test="${pageResult.currenpage == 1}">
											<li class="disablepage">上一页 &lt;&lt;</li>
										</c:if>
										<c:if test="${pageResult.currenpage != 1}">
											<li class="nextpage"><a href="${pageContext.request.contextPath}/showProductByPage?category=${category}&page=${pageResult.currenpage-1}">上一页 &lt;&lt;</a></li>
										</c:if>
										...
										<c:if test="${pageResult.currenpage != pageResult.totalpage}">
											<li class="nextpage"><a href="${pageContext.request.contextPath}/showProductByPage?category=${category}&page=${pageResult.currenpage+1}">下一页&gt;&gt;</a>
											</li>
										</c:if>
										<c:if test="${pageResult.currenpage == pageResult.totalpage}">
